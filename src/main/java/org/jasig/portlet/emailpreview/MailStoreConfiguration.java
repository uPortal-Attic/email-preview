...
public final class MailStoreConfiguration {
  ...
  public boolean isEwsUseMailAttribute() {
  ...
  public boolean supportsToggleSeen() {
    ...
    String protocol =
        this.getProtocol()
            .toLowerCase(); // Left toLowerCase in case existing installations have case wrong
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder()
        ...
        .append(
            this.allowableAuthenticationServiceKeys, owner.getAllowableAuthenticationServiceKeys())
