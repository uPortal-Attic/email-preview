...
public interface IEmailAccountService {
   ...
   * @param refresh True if the concrete service implementation must not return cached data;
   *     otherwise false
   * @return
  ...
  /**
   * Delete and expunge the specified massages from the store. Supported for implementations that
   * provide UIDs (e.g. UIDFolder) only.
   *
   * @param req The current {@link javax.portlet.PortletRequest}
  ...
  /**
   * Switch the value of the SEEN flag for the specified messages. Supported for implementations
   * that provide UIDs (e.g. UIDFolder) only.
   *
   * @param req The current {@link javax.portlet.PortletRequest}
   * @param messageIds
