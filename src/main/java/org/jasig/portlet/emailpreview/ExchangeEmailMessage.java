...
/**
 * Exchange email messages. Exchange messages have a change key that must be sent back on update
 * messages to allow the Exchange server to determine if the Email Message is still in the same
 * state or if another process modified it.
 *
