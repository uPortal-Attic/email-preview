...
/**
 * Describes an Exchange folder. This is a minimal implementation needed for Email Preview to be
 * able to identify and list the user's email folders in the UI.
 *
