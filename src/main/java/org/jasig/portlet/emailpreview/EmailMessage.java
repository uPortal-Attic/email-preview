...
public class EmailMessage {
  ...
  private static final FastDateFormat DATE_FORMAT =
      FastDateFormat.getInstance("h:mm a MMM d, yyyy");
  ...
  /**
   * Creates a new {@link EmailMessage} based on the specified <code>Message</code> and {@link
   * EmailMessageContent}.
   */
  public EmailMessage(
      int messageNumber,
  ...
  /**
   * Returns the UID of the message as set by the Folder or <code>null</code> if the Folder does not
   * implement UIDFolder.
   *
  ...
  /**
   * Returns the date the email message was sent or <code>null</code> if the server did not provide
   * one.
   *
  ...
  /**
   * @return The content type (e.g. "text/plain") of the message body or <code>null</code> if the
