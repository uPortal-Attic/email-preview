...
public interface ILinkServiceRegistry {
  ...
  /**
   * Return an instance of the link service associated with the supplied key. If no matching link
   * service can be found, this method will return <code>null</code>.
   *
   * @param key
   * @return
   */
