...
/**
 * Provides access to the various services (Email, AuthN, etc) in the portlet. This interfce
 * simplifies Spring configuration in that controllers need only have access to this broker, not a
 * blend of 3-4 independent services.
 *
