...
public interface IAuthenticationService {
  ...
  /**
   * Return the unique key for this authentication service. This key will be used to retrieve an
   * authentication service instance from the registry.
   *
   * @return
   */
  String getKey();
  ...
  /**
   * <code>True</code> if the specified parameters contain enough information to build a valid
   * <code>Authenticator</code> if they were passed to the {@link #getAuthenticator(PortletRequest,
   * MailStoreConfiguration)} method.
   *
   * @param request
   * @param config
   * @return
